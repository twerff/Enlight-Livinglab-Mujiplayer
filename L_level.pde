...
public class LVL
{
  ...
  public void activate(boolean onoff)
  {
    ...
    parent.EnlightParent.createMessage("DimLevelChanged", ADDRESS_PC, parent.getAddress(), i);
  }
  ...
  {
    saveDimLevel(value);
    parent.EnlightParent.createMessage("DimLevelChanged", ADDRESS_LVL+level, parent.getAddress(), getDimLevel());
  }
  ...
  {        
    saveCT(value);
    parent.EnlightParent.createMessage("timeUpdated", ADDRESS_PC, parent.getAddress(), getCT());
  }
